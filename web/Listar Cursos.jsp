...
<html>
    ...
    <body>
        ...
        <div id="pesquisa" class="container-fluid" style="position: absolute; width: 400px; margin-left: 158px; margin-bottom: -55px">
            <form class="d-flex">
                <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
                <a type="button" class="btn btn-outline-success" id="add" >Search</a>
            </form>
        </div>
        <table class="table"   style="position: relative; margin-left: auto; margin-right: auto;margin-top: 70px; text-align: center" >
            <a href="Cadastrar%20Cursos.jsp" type="button" class="btn btn-outline-success" id="add"  style="position: absolute; margin-left: 997px" ><b>+</b> Adicionar Novo Curso</a>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td></td>
                    <td class="text-center"><a class='btn btn-info btn-xs' href="#"><span class="glyphicon glyphicon-edit"></span> Editar</a> <a href="#" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Deletar</a> <a href="#" id="bntVer" class="btn btn-success btn-xs" style="background-color: #198754"><span class="glyphicon glyphicon-eye-open" ></span> Ver</a> <a class='btn btn-light btn-xs' href="#"><span class="glyphicon glyphicon-retweet"></span> On/Off</a> </td>
                </tr>
                <% }
